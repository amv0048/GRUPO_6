        ...
        <div class="info-col">
            ...
            <div class="info-body">
                ...
                <div class="botones-area">
                    ...
                    <button type="button" class="btn-compartir" id="btn-abrir-compartir">
...
<div class="share-modal" id="share-modal">
    ...
    <div class="share-modal-dialog">
        ...
        <div class="share-redes" id="share-redes-main">
            <a class="share-red whatsapp" id="share-whatsapp" href="#" target="_blank" rel="noopener noreferrer">
                <i class="zmdi zmdi-whatsapp"></i>
                <span>WhatsApp</span>
            </a>
            <a class="share-red twitter" id="share-twitter" href="#" target="_blank" rel="noopener noreferrer">
                <i class="zmdi zmdi-twitter"></i>
                <span>X / Twitter</span>
            </a>
            <a class="share-red telegram" id="share-telegram" href="#" target="_blank" rel="noopener noreferrer">
            ...
            <button class="share-red copiar" id="share-copiar">
                <i class="zmdi zmdi-link"></i>
                <span>Copiar</span>
            </button>
            <button class="share-red stories" id="share-stories">
        ...
        <div class="share-stories-section" id="share-stories-section" hidden>
            ...
            <div class="share-stories-acciones">
                <a id="btn-stories-descargar" class="btn-stories-descargar" href="#"
                   download="<?= htmlspecialchars($animal['nombre']) ?>-gocatch.png">
                    <i class="zmdi zmdi-download"></i> Descargar imagen
                </a>
                <button class="btn-stories-volver" id="btn-stories-volver">
                    ← Volver
                </button>
            </div>
...
<script src="/public/js/share-animal.js"></script>
